...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ url('/') }}/design/AdminLTE/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
  ...
  <link href="{{ url('/') }}/design/AdminLTE/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet">
